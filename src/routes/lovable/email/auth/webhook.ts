...
const EMAIL_SUBJECTS: Record<string, string> = {
  signup: 'Confirm your email — welcome to Frass',
  invite: "You've been invited to Frass Hill",
  magiclink: 'Your Frass sign-in link',
  recovery: 'Reset your Frass password',
  email_change: 'Confirm your new Frass email',
  reauthentication: 'Your Frass verification code',
}
