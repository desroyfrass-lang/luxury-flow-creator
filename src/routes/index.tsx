...
function DoorButton({
  ...
  return (
    <button
      ...
      onClick={onClick}
      data-tone={tone}
      className="door-glass relative flex-1 overflow-hidden rounded-2xl border border-[#bfe9ef]/50 bg-[#0d2a3a]/35 px-5 py-4 text-center font-[var(--font-display,'Archivo_Black',sans-serif)] text-sm font-bold uppercase tracking-[0.2em] text-[#eaf6fb] shadow-[0_10px_40px_-16px_rgba(8,40,60,0.65)] backdrop-blur-xl transition-all duration-300 ease-out hover:-translate-y-0.5 hover:border-[#7fd8e6]/80 hover:bg-[#0d2a3a]/50 hover:shadow-[0_16px_50px_-16px_rgba(127,216,230,0.7)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#7fd8e6] motion-reduce:transition-none"
    >
