...
export const COLLECTION_MAP: Record<string, { title: string; query: string; description?: string }> = {
  ...
  // Sports Drip (activewear)
  "sports-drip": { title: "Sports Drip", query: 'tag:"sports-drip"', description: "Built for Performance. Styled for Confidence." },
  "sports-drip-men": { title: "Men's Sports Drip", query: 'tag:"sports-drip" tag:"men"', description: "Built for Performance. Styled for Confidence." },
  "sports-drip-women": { title: "Women's Sports Drip", query: 'tag:"sports-drip" tag:"women"', description: "Move Freely. Train Boldly. Sculpt Beautifully." },
  "sports-drip-men-training-gear": { title: "Men's Training Gear", query: 'tag:"sports-drip" tag:"men" tag:"training"' },
  "sports-drip-men-activewear-sets": { title: "Men's Activewear Sets", query: 'tag:"sports-drip" tag:"men" tag:"sets"' },
  "sports-drip-men-running-performance": { title: "Men's Running & Performance", query: 'tag:"sports-drip" tag:"men" tag:"running"' },
  "sports-drip-men-basketball-court": { title: "Men's Basketball & Court Style", query: 'tag:"sports-drip" tag:"men" tag:"basketball"' },
  "sports-drip-men-gym-fits": { title: "Men's Gym Fits", query: 'tag:"sports-drip" tag:"men" tag:"gym"' },
  "sports-drip-women-training-essentials": { title: "Women's Training Essentials", query: 'tag:"sports-drip" tag:"women" tag:"training"' },
  "sports-drip-women-activewear-sets": { title: "Women's Activewear Sets", query: 'tag:"sports-drip" tag:"women" tag:"sets"' },
  "sports-drip-women-running-performance": { title: "Women's Running & Performance", query: 'tag:"sports-drip" tag:"women" tag:"running"' },
  "sports-drip-women-studio-yoga": { title: "Women's Studio & Yoga", query: 'tag:"sports-drip" tag:"women" tag:"yoga"' },
  "sports-drip-women-active-shapewear": { title: "Women's Active Shapewear", query: 'tag:"sports-drip" tag:"women" tag:"shapewear"' },
  // featured
