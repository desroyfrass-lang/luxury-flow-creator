...
export const PLATFORM_ATLAS: AtlasEntry[] = [
  ...
  { name: "The Daily", path: "/daily", purpose: "Today's execution desk — lanes, focus modes, widgets, the Frassy composer." },
  { name: "Control Room", path: "/founder", purpose: "Founder-only building and oversight. Never shown to Partners." },
  { name: "My Workspace", path: "/room", purpose: "Personal work hub — vault, uploads, projects, tools." },
  ...
  { name: "Business Builder", path: "/business-builder", purpose: "Strategy, offers, pricing and positioning per business." },
  ...
  { name: "Affiliate", path: "/affiliate", purpose: "Campaigns, links, commission simulator, attribution." },
  ...
  { name: "Frass Kicks", path: "/kicks", purpose: "Sneaker district — Casual, Classic, Street." },
  { name: "Frass Drip / Bare Drip / Plus+ / Kids", path: "/frass-drip", purpose: "Apparel houses, mirrored architecture across Plus+ and Kids." },
  { name: "Frass Shape", path: "/shape", purpose: "Shapewear and wellness flagship with the AI Fit Assistant." },
  { name: "Bridal", path: "/bridal", purpose: "The Wedding Village — checklist, concierge, vault." },
