...
export const STUDIO_NAV: StudioNavItem[] = [
  ...
  { id: "voices", label: "Voices", icon: "🎙️", to: "/studios/assets", search: { type: "voice" }, plain: "Saved voices and narration." },
  { id: "locations", label: "Locations", icon: "🌴", to: "/studios/assets", search: { type: "location" }, plain: "Places your stories happen." },
  { id: "animation", label: "Animation Library", icon: "🌀", to: "/studios/assets", search: { type: "character_animation" }, plain: "Reusable movement and animation." },
